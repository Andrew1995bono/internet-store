...
} from './components/all-products-components/all-products-content/all-products-content.component';
import {AsideComponent} from './components/all-products-components/all-products-content/aside/aside.component';
import {
  CategoriesComponent
} from './components/all-products-components/all-products-content/aside/categories/categories.component';
...
} from './components/all-products-components/all-products-content/product-card/product-card.component';
import {
  AllProductsTitleComponent
} from './components/all-products-components/all-products-title/all-products-title.component';
...
} from './components/order-page-components/order-page/information-confirmation/information-confirmation.component';
